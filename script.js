...
button.onclick = forceEndReset;
button.addEventListener("pointerup", forceEndReset, { capture: true });
button.addEventListener("touchend", forceEndReset, { capture: true });
});
}
